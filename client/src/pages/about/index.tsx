        ...
        <div className={styles.inner}>
          <div className={styles.infocard}>
            ...
            <p style={{ textAlign: 'center' }}>
              ...
              things separating us from other board services. Here you do not
              just move a card to a doing slot and leave - you throw it onto the
              workbench and start utilizing all your tools immidiately. Track
              your time and progress, and evaluate your planning. As if that is
              not enough, you get to customize your taskboard to fit your needs.
              Choose from multiple components, throw them on your board and get
              going!
            </p>
          </div>
        </div>
